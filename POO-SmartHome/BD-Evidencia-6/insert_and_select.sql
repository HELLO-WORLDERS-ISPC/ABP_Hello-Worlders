...
INSERT INTO ESCENARIOACCIONESDISPOSITVOS (ACCION_DETALLE) VALUES
('Apagar'),
('Encender');
...
INSERT INTO DISPOSITIVOS (NOMBRE_DISPOSITIVO, ESTADO, ID_ACCION, ID_TIPO_DISPOSITIVO, ID_USUARIO, ID_UBICACION) VALUES
('Luz Cocina', False, 2, 1, 1, 1),
('Luz Comedor', False, 2, 1, 2, 2),
('Luz Living', False, 2, 1, 3, 3),
('Cámara Entrada', False, 2, 2, 4, 20),
('Cámara Patio', False, 2, 2, 5, 9),
('Cámara Garage', False, 2, 2, 6, 8),
('Sensor Movimiento Pasillo', False, 1, 3, 7, 21),
('Sensor Dormitorio', False, 1, 3, 8, 4),
('Sensor Cocina', False, 1, 3, 9, 1),
('Sensor Baño', False, 1, 3, 10, 6),
('Aire Dormitorio', False, 2, 4, 11, 4),
('Aire Living', False, 2, 4, 12, 3),
('Aire Oficina', False, 2, 4, 13, 11),
('Aire Gimnasio', False, 2, 4, 14, 27),
('Persiana Dormitorio', False, 1, 6, 15, 4),
('Persiana Oficina', False, 1, 6, 16, 11),
('Persiana Living', False, 1, 6, 17, 3),
('Persiana Comedor', False, 1, 6, 18, 2),
('Alarma General', False, 2, 5, 19, 20),
('Alarma Patio', False, 2, 5, 20, 9),
('Luz Baño', False, 2, 1, 21, 6),
('Luz Terraza', False, 2, 1, 22, 10),
('Luz Piscina', False, 2, 1, 23, 24),
('Luz Jardín', False, 2, 1, 24, 14),
('Cámara Oficina', False, 1, 2, 25, 11),
('Cámara Gimnasio', False, 1, 2, 26, 27),
('Sensor Garage', False, 1, 3, 27, 8),
('Sensor Jardín', False, 1, 3, 28, 14),
('Aire Comedor', False, 2, 4, 29, 2),
('Luz Cine', False, 2, 1, 30, 28);
...
-- ESCENARIOACCIONESDISPOSITVOS
SELECT * FROM ESCENARIOACCIONESDISPOSITVOS;
SELECT ACCION_DETALLE FROM ESCENARIOACCIONESDISPOSITVOS;
SELECT * FROM ESCENARIOACCIONESDISPOSITVOS WHERE ACCION_DETALLE = 'Encender';
...
FROM DISPOSITIVOS d
JOIN ESCENARIOACCIONESDISPOSITVOS a 
...
JOIN ESCENARIOACCIONESDISPOSITVOS a ON e.ID_ACCION = a.ID_ACCION;
...
JOIN ESCENARIOACCIONESDISPOSITVOS a ON d.ID_ACCION = a.ID_ACCION
