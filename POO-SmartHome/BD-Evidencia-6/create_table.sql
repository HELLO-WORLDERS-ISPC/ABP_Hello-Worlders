...
CREATE TABLE ESCENARIOS (
  ...
  CONSTRAINT FK_ESCENARIOS_ACCION FOREIGN KEY (ID_ACCION) REFERENCES ESTADODISPOSITIVO(ID_ACCION)
);
...
CREATE TABLE DISPOSITIVOS (
  ...
  ID_UBICACION INT NOT NULL,
  CONSTRAINT FK_DISPOSITIVO_ACCION FOREIGN KEY (ID_ACCION) REFERENCES ESTADODISPOSITIVO(ID_ACCION),
